...
import com.davinchicoder.spring_boot_async_template_community.infrastructure.kafka.util.MessagingUtils;
...
public class KafkaConsumer implements Consumer<Message<GenericRecord>> {
    ...
    private final Map<String, com.davinchicoder.spring_boot_async_template_community.infrastructure.kafka.EventSpecificConsumer<SpecificRecord>> specificConsumersMap;
    private final MessagingUtils messagingUtils;


    public KafkaConsumer(List<com.davinchicoder.spring_boot_async_template_community.infrastructure.kafka.EventSpecificConsumer> specificConsumerList, MessagingUtils messagingUtils) {
